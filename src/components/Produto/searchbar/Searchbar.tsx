 ...
 return (
    ...
    <div className="flex  gap-4">
      <input
        ...
        className="border-2 border-bege rounded p-2 text-ros"
      />
...
<button  type='submit' className="rounded bg-ros hover:bg-ros text-bege w-1/2 py-2 flex justify-center"> Pesquisar </button>
  </>
);
}
