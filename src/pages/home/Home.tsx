import './Home.css';
import imgp from '../../assets/img/maos.png'
import img1 from '../../assets/img/prato.jpg'
import img2 from '../../assets/img/costura.jpg'
import img3 from '../../assets/img/carimbo.jpg'
import img4 from '../../assets/img/composicao.jpg'
    ...
    return (
        ...
        <div className='container-cols-3 flex justify-around justify-between px-4 pyy text-center text-ver font-bold font-archivo'>
          <div className='justify-center items-center'>
            <img src={img1} alt="Imagem de prato" className='imgdef rounded-2xl mb-4'/>
